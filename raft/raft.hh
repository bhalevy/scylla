...
using term_t = utils::tagged_integral<struct term_tag, int64_t>;
// This type represensts the index into the raft log
using index_t = utils::tagged_integral<struct index_tag, uint64_t>;
// Identifier for a read barrier request
using read_id = utils::tagged_integral<struct read_id_tag, uint64_t>;
