...
.. list-table::
   ...
   * - seeds
     - The broadcast_address of existing nodes. You must specify the address of at least one existing node. Multiple addresses may be separated by comma characters.
   * - endpoint_snitch
