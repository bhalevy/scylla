...
@pytest.mark.parametrize("with_tablet_hints", [False, True])
def test_desc_table(cql, test_keyspace, random_seed, has_tablets, with_tablet_hints:bool):
    if has_tablets:  # issue #18180
        global counter_table_chance
        counter_table_chance = 0
    tablet_hints = {}
    if with_tablet_hints:
        tablet_hints = {
            'min_tablet_count': '100',
            'min_per_shard_tablet_count': '10.5',
