...
SEASTAR_TEST_CASE(sstable_scrub_quarantine_mode_test) {
    ...
    return do_with_cql_env([this] (cql_test_env& cql_env) -> future<> {
        return test_env::do_with_async([this, &cql_env] (test_env& env) {
            ...
            // We expect the scrub with mode=scrub::mode::vallidate to quarantine the sstable.
            sstables::compaction_type_options::scrub opts = {};
            ...
            // The sstable should be found and scrubbed when scrub::quarantine_mode is scrub::quarantine_mode::only
