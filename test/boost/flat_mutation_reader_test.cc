...
static size_t count_fragments(mutation m) {
  return with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), {m}), [] (flat_mutation_reader& r) {
    size_t res = 0;
    ...
    return seastar::async([] {
        for_each_mutation([&] (const mutation& m) {
            ...
            for (size_t depth = 1; depth <= fragments_in_m + 1; ++depth) {
              with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), {m}), [&] (flat_mutation_reader& r) {
    ...
    return seastar::async([] {
        auto test = [] (mutation m1, mutation m2) {
            ...
            for (size_t depth = 1; depth < fragments_in_m1; ++depth) {
              with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), {m1, m2}), [&] (flat_mutation_reader& r) {
               ...
               with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), {m1, m2}), [&] (flat_mutation_reader& r2) {
...
SEASTAR_THREAD_TEST_CASE(test_flat_mutation_reader_move_buffer_content_to) {
    struct dummy_reader_impl : public flat_mutation_reader::trivially_abortable_impl {
        dummy_reader_impl(schema_ptr s, reader_permit permit) : trivially_abortable_impl(std::move(s), std::move(permit), "flat_mutation_reader_test::dummy_reader_impl") { }
    ...
    auto close_dummy = defer([&dummy_reader] { dummy_reader.close().get(); });
...
void test_flat_stream(schema_ptr s, std::vector<mutation> muts, reversed_partitions reversed, in_thread thread) {
  ...
  with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), muts), [&] (flat_mutation_reader& fmr) {
...
SEASTAR_TEST_CASE(test_abandoned_flat_mutation_reader_from_mutation) {
    return seastar::async([] {
        for_each_mutation([&] (const mutation& m) {
          with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), {mutation(m)}), [] (flat_mutation_reader& rd) {
...
SEASTAR_THREAD_TEST_CASE(test_mutation_reader_from_fragments_as_mutation_source) {
    auto populate = [] (schema_ptr, const std::vector<mutation> &muts) {
        return mutation_source([=] (
            ...
            with_flat_mutation_reader(flat_mutation_reader_from_mutations(tests::make_permit(), squash_mutations(muts)), [&] (flat_mutation_reader& frag_rd) {
              return frag_rd.consume_pausable([&fragments] (mutation_fragment mf) {
...
SEASTAR_THREAD_TEST_CASE(test_reverse_reader_memory_limit) {
    ...
    auto test_with_partition = [&] (bool with_static_row) {
      ...
      with_flat_mutation_reader_in_thread(flat_mutation_reader_from_mutations(tests::make_permit(), {mut}), [&] (flat_mutation_reader& reader) {
       with_flat_mutation_reader_in_thread(make_reversing_reader(reader, query::max_result_size(size_t(1) << 10, hard_limit)), [&] (flat_mutation_reader& reverse_reader) {
