...
SEASTAR_THREAD_TEST_CASE(tablets_basic_rack_aware_view_pairing_test) {
    auto my_address = gms::inet_address("localhost");
    ...
    testlog.debug("my_location: {}/{}", topology.get_location().dc, topology.get_location().rack);
    ...
    std::unordered_map<locator::host_id, gms::inet_address> base_to_view_pairing;
    std::unordered_map<gms::inet_address, locator::host_id> view_to_base_pairing;
