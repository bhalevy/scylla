...
static future<> test_freeze_unfreeze(std::function<frozen_mutation(const mutation&)> freeze_func, std::function<mutation(const frozen_mutation&, schema_ptr)> unfreeze_func) {
