...
BOOST_AUTO_TEST_CASE(test_push_back_using_existing_element) {
    ...
    do_test_push_back_using_existing_element<utils::chunked_vector<push_back_item>>([] (utils::chunked_vector<push_back_item>& v, const push_back_item& x) { v.push_back(x); });
    do_test_push_back_using_existing_element<utils::chunked_vector<push_back_item>>([] (utils::chunked_vector<push_back_item>& v, const push_back_item& x) { v.emplace_back(x); });
}
