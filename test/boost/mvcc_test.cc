    ...
    return seastar::async([] {
        {
...

            {
                ...
                actual.compact_for_compaction(*s, std::nullopt, never_gc, m1.decorated_key(), gc_clock::now());
                expected.compact_for_compaction(*s, std::nullopt, never_gc, m1.decorated_key(), gc_clock::now());
