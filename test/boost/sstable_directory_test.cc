...
public:
    ...
    static future<> reshard(sharded<sstables::sstable_directory>& dir, sharded<replica::database>& db, sstring ks_name, sstring table_name, compaction::compaction_sstable_creator_fn creator, owned_ranges_ptr owned_ranges_ptr = nullptr) {
