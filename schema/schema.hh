...
private:
    ...
    struct raw_schema {
        ...
        std::map<sstring, sstring> _tablet_hints;
...
public:
    ...
    bool has_tablet_hints() const noexcept;
    db::tablet_hints tablet_hints() const noexcept;
    const db::tablet_hints::map_type& raw_tablet_hints() const noexcept;
