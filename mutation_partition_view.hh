...
private:
    ...
    accept_ordered_result do_accept_ordered(const schema& schema, mutation_partition_view_virtual_visitor& mpvvv, accept_ordered_cookie cookie, is_preemptible preempt) const;
...
public:
    ...
    future<> accept_gently(const schema& s, partition_builder& visitor) const;
