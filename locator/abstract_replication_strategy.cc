...
abstract_replication_strategy::get_ranges_async(inet_address ep, const token_metadata& tm) const {
    return do_with(dht::token_range_vector(), dht::token(),
            [this, ep, &tm] (dht::token_range_vector& ret, dht::token& prev_tok) {
