...
effective_replication_strategy::do_get_ranges(Predicate add_range) const {
    dht::token_range_vector ret;
...
future<dht::token_range_vector>
effective_replication_strategy::get_primary_ranges(inet_address ep) {
    return do_get_ranges([ep] (inet_address_vector_replica_set eps) {
...
future<dht::token_range_vector>
effective_replication_strategy::get_primary_ranges_within_dc(inet_address ep) {
