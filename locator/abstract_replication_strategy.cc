...
dht::token_range_vector
abstract_replication_strategy::get_ranges_in_thread(inet_address ep, token_metadata_ptr tmptr) const {
...
dht::token_range_vector
abstract_replication_strategy::do_get_ranges(inet_address ep, token_metadata_ptr tmptr, bool can_yield) const {
    dht::token_range_vector ret;
    const auto& tm = *tmptr;
...
dht::token_range_vector
abstract_replication_strategy::get_pending_address_ranges(token_metadata_ptr tmptr, token pending_token, inet_address pending_address) const {
    return get_pending_address_ranges(std::move(tmptr), std::unordered_set<token>{pending_token}, pending_address);
}

dht::token_range_vector
abstract_replication_strategy::get_pending_address_ranges(token_metadata_ptr tmptr, std::unordered_set<token> pending_tokens, inet_address pending_address) const {
    dht::token_range_vector ret;
