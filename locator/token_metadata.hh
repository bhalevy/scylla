...
using token_metadata_ptr = lw_shared_ptr<token_metadata>;

template <typename... Args>
token_metadata_ptr make_token_metadata_ptr(Args... args) {
...
public:
    ...
    const token_metadata_ptr get() const noexcept {
        return _shared;
    }

    token_metadata_ptr clone() const {
        return make_token_metadata_ptr(*_shared);
    }

    void set(token_metadata_ptr tmptr) noexcept {
