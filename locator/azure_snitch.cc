...
azure_snitch::azure_snitch(db::system_keyspace& sys_ks, const sstring& fname, unsigned io_cpuid)
...
using registry_2_params = class_registrator<i_endpoint_snitch, azure_snitch, db::system_keyspace&, const sstring&, const unsigned&>;
...
using registry_1_param = class_registrator<i_endpoint_snitch, azure_snitch, db::system_keyspace&, const sstring&>;
...
using registry_default = class_registrator<i_endpoint_snitch, azure_snitch, db::system_keyspace&>;
