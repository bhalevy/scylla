...
private:
    ...
    static const tablet_replica sort_and_get_primary_replica(const tablet_replica_set& replicas, tablet_id id, std::function<bool(const tablet_replica&)> filter_func = {});
