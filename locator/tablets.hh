...
public:
    ...
    using primary_replica_map = std::unordered_map<tablet_id, tablet_replica>;
private:
...
public:
    ...
    /// Selects a primary replica per tablet for the table, optionally within a given dc
    future<primary_replica_map> calc_primary_replica_map(table_id table, const topology& topo, sstring dc = "") const;
