...
stop_iteration local_strategy::for_each_natural_endpoint_until(const noncopyable_function<stop_iteration(const inet_address&)>& func, const token&, const effective_replication_map&) const {
