...
effective_replication_map_ptr local_strategy::make_replication_map(table_id, token_metadata_ptr tmptr) const {
    return seastar::make_shared<local_effective_replication_map>(shared_from_this(), std::move(tmptr));
}
