...
host_id_vector_replica_set local_effective_replication_map::get_natural_replicas(search_token) const {
    return _replica_set;
}
...
host_id_vector_replica_set local_effective_replication_map::get_replicas_for_reading(search_token) const {
    return _replica_set;
}

host_id_vector_replica_set local_effective_replication_map::get_replicas(search_token) const {
    return _replica_set;
}
