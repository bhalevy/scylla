...
using keyspace_effective_replication_map = vnode_effective_replication_map;
...
inline mutable_keyspace_erm_ptr make_effective_replication_map(replication_strategy_ptr rs, token_metadata_ptr tmptr, replication_map replication_map, ring_mapping pending_endpoints,
...
future<mutable_keyspace_erm_ptr> calculate_effective_replication_map(replication_strategy_ptr rs, token_metadata_ptr tmptr);
...
public:
    ...
    future<keyspace_erm_ptr> create_effective_replication_map(replication_strategy_ptr rs, token_metadata_ptr tmptr);
