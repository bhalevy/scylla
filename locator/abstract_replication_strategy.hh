...
public:
    ...
    future<dht::token_range_vector> get_ranges(inet_address ep) const;
    ...
    future<dht::token_range_vector> get_primary_ranges(inet_address ep);
    ...
    future<dht::token_range_vector> get_primary_ranges_within_dc(inet_address ep);
...
private:
    ...
    future<dht::token_range_vector> do_get_ranges(Predicate add_range) const;
};
