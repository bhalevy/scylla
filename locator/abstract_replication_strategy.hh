...
protected:
    ...
    const shared_token_metadata _token_metadata;
    snitch_ptr& _snitch;
...
public:
    ...
    static std::unique_ptr<abstract_replication_strategy> create_replication_strategy(const sstring& ks_name, const sstring& strategy_name, const shared_token_metadata& token_metadata, const std::map<sstring, sstring>& config_options);
