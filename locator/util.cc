...
static future<utils::unordered_map<dht::token_range, host_id_vector_replica_set>>
construct_range_to_endpoint_map(
        locator::effective_replication_map_ptr erm,
        const dht::token_range_vector& ranges) {
    utils::unordered_map<dht::token_range, host_id_vector_replica_set> res;
...
get_range_to_address_map_in_local_dc(
    ...
    utils::unordered_map<dht::token_range, host_id_vector_replica_set> filtered_map;
...
// static future<utils::unordered_map<dht::token_range, inet_address_vector_replica_set>>
...
describe_ring(const replica::database& db, const gms::gossiper& gossiper, const sstring& keyspace, bool include_only_local_dc) {
    ...
    utils::unordered_map<dht::token_range, host_id_vector_replica_set> range_to_address_map = co_await (
