...
void set_failure_detector(http_context& ctx, routes& r, gms::gossiper& g) {
    ...
    fd::get_endpoint_phi_values.set(r, [](std::unique_ptr<request> req) {
        // FIXME: this was based on gms::get_arrival_samples.
        // But the latter returned an empty std::map<inet_address, arrival_window>.
        // The functionality needs to be implemented by the failure detector.
