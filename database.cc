...
database::stop() {
    ...
    return maybe_shutdown_commitlog.then([this] {
        ...
        return when_all_succeed(_read_concurrency_sem.evict_all_inactive_reads(),
                _streaming_concurrency_sem.evict_all_inactive_reads(),
                _system_read_concurrency_sem.evict_all_inactive_reads()).discard_result();
    });
}
