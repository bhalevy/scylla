...
database::database(const db::config& cfg, database_config dbcfg, service::migration_notifier& mn, gms::feature_service& feat, const locator::shared_token_metadata& stm, abort_source& as)
...
void keyspace_metadata::validate(const locator::shared_token_metadata& tm) const {
    using namespace locator;
