...
>>>>>>> dd5e89b8d9 (WIP gossiper: pass host_id to subscribers)
...
>>>>>>> 6d8e2b6b6f (WIP gossiper: pass host_id to subscribers)
...
=======
    inet_address get_address(locator::host_id, throw_on_error = throw_on_error::yes) const;
