...
public:
     ...
     */
    future<> advertise_removing(inet_address endpoint, ::host_id host_id, ::host_id local_host_id);
     ...
     * @param host_id
     */
    future<> advertise_token_removed(inet_address endpoint, ::host_id host_id);
...
public:
    ...
    bool is_safe_for_restart(inet_address endpoint, ::host_id host_id);
private:
    /**
