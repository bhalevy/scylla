...
private:
    ...
    // Must be called under lock_endpoint.
    future<> do_on_change_notifications(inet_address addr, const gms::endpoint_state::map_type& states, permit_id) const;
...
public:
     ...
     */
    future<> start_gossiping(gms::generation_type generation_nbr, endpoint_state::map_type preload_local_states = {},
...
public:
     ...
     */
    future<> add_local_application_state(endpoint_state::map_type states);
