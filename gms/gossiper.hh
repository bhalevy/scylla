...
public:
    ...
    future<endpoint_permit> lock_endpoint(inet_address, permit_id pid = null_permit_id, seastar::compat::source_location l = seastar::compat::source_location::current());
