...
private:
    ...
    // Must be called under lock_endpoint.
    future<> do_on_change_notifications(inet_address addr, const application_states_map& states, permit_id) const;
...
public:
     ...
     */
    future<> start_gossiping(gms::generation_type generation_nbr, application_states_map preload_local_states = {},
...
public:
     ...
     */
    future<> add_local_application_state(application_states_map states);
