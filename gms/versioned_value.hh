...
public:
    ...
    static versioned_value host_id(const ::host_id& host_id) {
    ...
    static versioned_value removing_nonlocal(const ::host_id& host_id) {
        return versioned_value(sstring(REMOVING_TOKEN) +
            sstring(DELIMITER_STR) + host_id.to_sstring());
    }

    static versioned_value removed_nonlocal(const ::host_id& host_id, int64_t expire_time) {
    ...
    static versioned_value removal_coordinator(const ::host_id& host_id) {
