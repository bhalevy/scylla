...
using generation_type = utils::tagged_generation_type<struct generation_type_tag, int32_t>;
using version_type = utils::tagged_generation_type<struct version_type_tag, int32_t>;
