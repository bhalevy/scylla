...
protected:
    future<> on_application_state_change(inet_address endpoint, const endpoint_state::map_type& states, application_state app_state, permit_id,
...
public:
    ...
    virtual future<> on_change(inet_address endpoint, const endpoint_state::map_type& states, permit_id) = 0;
