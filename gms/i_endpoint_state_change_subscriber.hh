...
protected:
    future<> on_application_state_change(inet_address endpoint, const application_states_map& states, application_state app_state, permit_id,
...
public:
    ...
    virtual future<> on_change(inet_address endpoint, const application_states_map& states, permit_id) = 0;
