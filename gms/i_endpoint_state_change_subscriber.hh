...
public:
     ...
     */
    virtual future<> on_join(endpoint_id endpoint, endpoint_state ep_state) = 0;

    virtual future<> before_change(endpoint_id endpoint, endpoint_state current_state, application_state new_statekey, const versioned_value& newvalue) = 0;

    virtual future<> on_change(endpoint_id endpoint, application_state state, const versioned_value& value) = 0;

    virtual future<> on_alive(endpoint_id endpoint, endpoint_state state) = 0;

    virtual future<> on_dead(endpoint_id endpoint, endpoint_state state) = 0;

    virtual future<> on_remove(endpoint_id endpoint) = 0;
     ...
     */
    virtual future<> on_restart(endpoint_id endpoint, endpoint_state state) = 0;
};
