...
static distributed<gossiper> _the_global_gossiper;
distributed<gossiper>* _the_gossiper = &_the_global_gossiper;
  ...
  (void)seastar::with_semaphore(_callback_running, 1, [this] {
    return seastar::async([this, g = this->shared_from_this()] {
            ...
            if (live_endpoint_changed || unreachable_endpoint_changed) {
                ...
                get_gossiper().invoke_on_all([this, live_endpoint_changed, unreachable_endpoint_changed, es = endpoint_state_map] (gossiper& local_gossiper) {
