...
void gossiper::add_quarantined_host(locator::host_id host_id) {
    if (!host_id) {
        on_internal_error(logger, "Null quarantined host_id");
    }
    ...
    logger.debug("Added quarantined host {}", host_id);
}
