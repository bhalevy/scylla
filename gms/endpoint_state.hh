...
using application_states_map = std::unordered_map<application_state, versioned_value>;
...
private:
    ...
    application_states_map _application_state;
...
public:
    ...
    endpoint_state(heart_beat_state&& initial_hb_state,
            const application_states_map& application_state)
     ...
     */
    // @Deprecated
    application_states_map& get_application_state_map() noexcept {
        return _application_state;
    }

    const application_states_map& get_application_state_map() const noexcept {
        return _application_state;
    }
