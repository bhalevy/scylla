...
static_assert(std::is_nothrow_default_constructible_v<application_states_map>);
...
future<> i_endpoint_state_change_subscriber::on_application_state_change(inet_address endpoint,
        const gms::application_states_map& states, application_state app_state, permit_id pid,
