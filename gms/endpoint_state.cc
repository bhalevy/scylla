...
static_assert(std::is_nothrow_default_constructible_v<endpoint_state::map_type>);
...
future<> i_endpoint_state_change_subscriber::on_application_state_change(inet_address endpoint,
        const gms::endpoint_state::map_type& states, application_state app_state, permit_id pid,
