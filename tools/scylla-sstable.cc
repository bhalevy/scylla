...
const char* to_string(sstables::scylla_metadata_type t) {
    switch (t) {
        ...
        case sstables::scylla_metadata_type::SSTableGeneration: return "sstable_generation";
    }
    std::abort();
}
...
public:
    ...
    void operator()(const sstables::scylla_metadata::sstable_generation& gen) const {
        _writer.AsString(gen.value);
    }
};
