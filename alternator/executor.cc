...
static future<executor::request_return_type> do_query(service::storage_proxy& proxy,
    ...
    if (exclusive_start_key) {
        ...
        paging_state = make_lw_shared<service::pager::paging_state>(pk, pos, query::max_partitions, query_id::make_null(), service::pager::paging_state::replicas_per_token_range{}, std::nullopt, 0);
    }
