...
class distributed_loader {
    ...
    friend class sstables_metadata;
    ...
    static future<> populate_column_family(sstables_metadata& metadata, sstring subdir, allow_offstrategy_compaction, must_exist = must_exist::yes);
