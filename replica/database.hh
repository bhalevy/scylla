...
using sstable_map = sstables::sstable_map;
...
public:
    ...
    lw_shared_ptr<const sstable_map> get_sstables() const;
    lw_shared_ptr<const sstable_map> get_sstables_including_compacted_undeleted() const;
