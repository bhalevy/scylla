...
storage_group_manager::storage_group_manager(replica::table& t) : _t(t) {}
...
public:
    tablet_storage_group_manager(replica::table& t, const locator::effective_replication_map_ptr& erm)
    ...
    lw_shared_ptr<sstables::sstable_set> make_sstable_set() const override {
        ...
        return make_tablet_sstable_set(*this);
    }
};
