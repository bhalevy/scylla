...
public:
    ...
    new_keyspace(std::string_view name,
                 ...
                 std::vector<schema_ptr> cf_defs = std::vector<schema_ptr>{});
    void validate(const locator::shared_token_metadata& tm) const;
...
public:
    ...
    database(const db::config&, database_config dbcfg, service::migration_notifier& mn, gms::feature_service& feat, const locator::shared_token_metadata& stm, abort_source& as);
    ...
    const locator::shared_token_metadata& get_shared_token_metadata() const { return _token_metadata; }
    const locator::token_metadata& get_token_metadata() const { return _token_metadata.get(); }
