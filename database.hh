...
future<> system_keyspace_make(distributed<database>& db, distributed<service::storage_service>& ss, sharded<gms::gossiper>& gossiper, db::config& cfg);
...
private:
    ...
    friend future<> db::system_keyspace_make(distributed<database>& db, distributed<service::storage_service>& ss, sharded<gms::gossiper>& gossiper, db::config& cfg);
    void setup_metrics();
