...
public:
    ...
    static future<> probe_file(distributed<database>& db, sstables::entry_descriptor, sstring fname);
    static future<> cleanup_column_family(distributed<database>& db, sstring sstdir, sstring ks, sstring cf);
    static future<> cleanup_column_family_sstables(distributed<database>& db, sstring sstdir, sstring ks, sstring cf);
