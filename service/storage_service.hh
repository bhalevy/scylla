...
public:
     ...
     */
    virtual future<> on_change(gms::inet_address endpoint, const gms::application_states_map& states, gms::permit_id) override;
...
private:
    ...
    static data_values_map get_peer_info_for_update(inet_address endpoint, const gms::application_states_map& app_state_map);
