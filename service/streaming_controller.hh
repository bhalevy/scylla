...
public:
    struct config {
        ...
        utils::updateable_value<float> min_shares;
        utils::updateable_value<float> max_shares;
    ...
    utils::observer<float> _min_shares_observer;
    utils::observer<float> _max_shares_observer;
