...
storage_proxy::query_singular(lw_shared_ptr<query::read_command> cmd,
    ...
    try {
        ...
        // `erm` capture below protects `&tm`
        auto handle_completion = [&used_replicas, &tm, erm] (std::pair<::shared_ptr<abstract_read_executor>, dht::token_range>& executor_and_token_range) {
