...
public:
    ...
    bool should_pull_schema_from(locator::host_id host_id);
    bool has_compatible_schema_tables_version(locator::host_id host_id);
...
private:
    ...
    void schedule_schema_pull(locator::host_id host_id, const gms::endpoint_state& state);

    future<> maybe_schedule_schema_pull(const table_schema_version& their_version, locator::host_id host_id);
...
private:
    virtual future<> on_join(locator::host_id host_id, gms::endpoint_state_ptr ep_state, gms::permit_id) override;
    virtual future<> on_change(locator::host_id host_id, gms::application_state state, const gms::versioned_value& value, gms::permit_id) override;
    virtual future<> on_alive(locator::host_id host_id, gms::endpoint_state_ptr state, gms::permit_id) override;
    virtual future<> on_dead(locator::host_id host_id, gms::endpoint_state_ptr state, gms::permit_id) override { return make_ready_future(); }
    virtual future<> on_remove(locator::host_id host_id, gms::permit_id) override { return make_ready_future(); }
    virtual future<> on_restart(locator::host_id host_id, gms::endpoint_state_ptr state, gms::permit_id) override { return make_ready_future(); }
    virtual future<> before_change(locator::host_id host_id, gms::endpoint_state_ptr current_state, gms::application_state new_statekey, const gms::versioned_value& newvalue) override { return make_ready_future(); }
