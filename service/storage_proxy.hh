...
public:
    ...
    const locator::token_metadata& get_token_metadata() const noexcept { return _token_metadata.get(); }
...
public:
    storage_proxy(distributed<database>& db, config cfg, db::view::node_update_backlog& max_view_update_backlog,
            scheduling_group_key stats_key, gms::feature_service& feat, const locator::shared_token_metadata& tokens, netw::messaging_service& ms);
    ~storage_proxy();
