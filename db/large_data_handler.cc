...
cql_table_large_data_handler::cql_table_large_data_handler(gms::feature_service& feat,
    ...
    , _partition_threshold_mb_updater(_partition_threshold_bytes, std::move(partition_threshold_mb), MB)
    , _row_threshold_mb_updater(_row_threshold_bytes, std::move(row_threshold_mb), MB)
    , _cell_threshold_mb_updater(_cell_threshold_bytes, std::move(cell_threshold_mb), MB)
