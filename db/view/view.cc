...
get_view_natural_endpoint(
    ...
    if (base_it == base_endpoints.end()) {
        ...
        vlogger.warn("Could not find {} in base_endpoints={}", me,
                orig_base_endpoints | std::views::transform([] (const locator::node& n) { return fmt::format("{}/{}", n.host_id(), n.endpoint()); }));
        return {};
    }
    ...
    if (idx >= view_endpoints.size()) {
        ...
        vlogger.warn("Could not pair {}: rack_aware={} base_endpoints={} view_endpoints={}", me,
                ...
                orig_base_endpoints | std::views::transform([] (const locator::node& n) { return fmt::format("{}/{}", n.host_id(), n.endpoint()); }),
                orig_view_endpoints | std::views::transform([] (const locator::node& n) { return fmt::format("{}/{}", n.host_id(), n.endpoint()); }));
        return {};
    }
