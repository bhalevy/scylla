...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , compaction_collection_items_count_warning_threshold(this, "compaction_collection_items_count_warning_threshold", value_status::Used, 10000,
        "Log a warning when writing a collection containing more items than this value")
