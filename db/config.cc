...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , streaming_disk_utilization_threshold(this, "streaming_disk_utilization_threshold", liveness::LiveUpdate, value_status::Used, 0.9,
        "Set the threshold of disk utilization percentage for streaming/maintenance scheduling group controller. Do not set this unless you know what you are doing and suspect a problem in streaming.")
