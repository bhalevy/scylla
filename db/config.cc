...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , enable_sstables_md_format(this, "enable_sstables_md_format", value_status::Used, false, "Enable SSTables 'md' format to be used as the default file format (overrides enable_sstables_mc_format)")
