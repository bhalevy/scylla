...
future<> generation_service::on_join(locator::host_id host_id, gms::endpoint_state_ptr ep_state, gms::permit_id pid) {
    assert_shard_zero(__PRETTY_FUNCTION__);
...
future<> generation_service::on_change(locator::host_id host_id, gms::application_state app_state, const gms::versioned_value& v, gms::permit_id) {
    assert_shard_zero(__PRETTY_FUNCTION__);
