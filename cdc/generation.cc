...
future<> generation_service::on_join(gms::endpoint_id ep, gms::endpoint_state ep_state) {
    assert_shard_zero(__PRETTY_FUNCTION__);
...
future<> generation_service::on_change(gms::endpoint_id ep, gms::application_state app_state, const gms::versioned_value& v) {
    assert_shard_zero(__PRETTY_FUNCTION__);
