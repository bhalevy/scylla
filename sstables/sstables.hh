...
private:
    ...
    future<> create_links_common(sstring dst_dir, int64_t dst_gen, bool mark_for_removal) const;
    future<> create_links_and_mark_for_removal(sstring dst_dir, int64_t dst_gen) const;
public:
