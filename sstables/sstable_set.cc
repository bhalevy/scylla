...
sstable_set_impl_ptr partitioned_sstable_set::clone() const {
    return seastar::make_shared<partitioned_sstable_set>(_schema, _unleveled_sstables, _leveled_sstables, _all, _all_runs, _use_level_metadata);
}
