...
public:
    ...
    sstable_position_reader_queue(const time_series_sstable_set& set,
        ...
        , _dummy_reader(make_flat_mutation_reader_from_mutation_v2(_query_schema,
        ...
        mutation_reader::forwarding fwd_mr) const
{
    ...
    if (num_readers != num_sstables) {
        readers.push_back(make_flat_mutation_reader_from_mutation_v2(schema, permit, mutation(schema, *pos.key()), slice, fwd));
    }
