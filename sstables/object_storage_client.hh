...
public:
    ...
    object_name(std::string_view bucket, const prefix_formatter& prefix, std::string_view type);
    object_name(std::string_view bucket, const prefix_formatter& prefix, const generation_type&, std::string_view type);
