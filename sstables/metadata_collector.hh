...
struct column_stats {
    ...
    /** the largest/smallest (client-supplied) timestamp of live data in the partition, for the purpose of tombstone_gc **/
     ...
     ** for the purpose of tombstone_gc of shadowable tombstones **/
