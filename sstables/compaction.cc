...
private:
    ...
    virtual std::function<bool(const dht::decorated_key&)> consider_partition() const {
...
public:
    ...
    virtual std::function<bool(const dht::decorated_key&)> consider_partition() const override {
        return [] (const dht::decorated_key& dk){
...
public:
    ...
    std::function<bool(const dht::decorated_key&)> consider_partition() const override {
