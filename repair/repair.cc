...
future<> bootstrap_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr, std::unordered_set<dht::token> bootstrap_tokens) {
...
static future<> do_decommission_removenode_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr, gms::inet_address leaving_node) {
    using inet_address = gms::inet_address;
...
future<> decommission_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr) {
    return do_decommission_removenode_with_repair(db, ms, std::move(tmptr), utils::fb_utilities::get_broadcast_address());
}

future<> removenode_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr, gms::inet_address leaving_node) {
    return do_decommission_removenode_with_repair(db, ms, std::move(tmptr), std::move(leaving_node));
}

static future<> do_rebuild_replace_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr, sstring op, sstring source_dc, streaming::stream_reason reason) {
...
future<> rebuild_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr, sstring source_dc) {
...
future<> replace_with_repair(seastar::sharded<database>& db, seastar::sharded<netw::messaging_service>& ms, const locator::token_metadata_ptr tmptr, std::unordered_set<dht::token> replacing_tokens) {
  return tmptr->clone_async().then([&db, &ms, replacing_tokens = std::move(replacing_tokens)] (locator::token_metadata tm) mutable {
    ...
    tm.update_normal_tokens(std::move(replacing_tokens), utils::fb_utilities::get_broadcast_address());
    return do_rebuild_replace_with_repair(db, ms, make_lw_shared<locator::token_metadata>(std::move(tm)), std::move(op), std::move(source_dc), reason);
  });
}
