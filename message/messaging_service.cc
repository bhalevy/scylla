    ...
    , _scheduling_info_for_connection_index(initial_scheduling_info())
{
    ...
    register_handler(this, messaging_verb::CLIENT_ID, [] (rpc::client_info& ci, gms::inet_address broadcast_address, uint32_t src_cpu_id, rpc::optional<uint64_t> max_result_size, std::optional<locator::host_id> host_id) {
