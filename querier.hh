...
public:
    querier_base(reader_permit permit, querier_reader_context_ptr ctx, flat_mutation_reader_v2 reader)
    ...
    virtual dht::partition_ranges_view ranges() const {
        return dht::partition_ranges_view(range());
    }
...
public:
    shard_mutation_querier(
        ...
        : querier_base(permit, std::move(ctx), std::move(reader))
