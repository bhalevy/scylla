...
verb [[with_client_info, with_timeout]] paxos_prepare (query::read_command cmd, partition_key key, service::paxos::ballot_id ballot, bool only_digest, query::digest_algorithm da, std::optional<tracing::trace_info> trace_info) -> service::paxos::prepare_response [[unique_ptr]];
...
verb [[with_client_info, with_timeout, one_way]] paxos_prune (table_schema_version schema_id, partition_key key [[ref]], service::paxos::ballot_id ballot, std::optional<tracing::trace_info> trace_info);
