...
verb [[with_client_info, abortable]] migration_request (netw::schema_pull_options options [[version 3.2.0]]) -> std::vector<frozen_mutation>, std::vector<canonical_mutation> [[version 3.2.0]]
verb get_schema_version (unsigned shard, table_schema_version version) -> frozen_schema
verb [[abortable]] schema_check () -> table_schema_version
