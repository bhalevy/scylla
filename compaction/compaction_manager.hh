...
private:
    ...
    std::vector<sstables::shared_sstable> get_candidates(compaction::table_state& t, const Range& sstables) const;
    ...
    future<compaction_stats_opt> perform_task_on_all_files(compaction::table_state& t, sstables::compaction_type_options options, compaction::owned_ranges_ptr, get_candidates_func, Args... args);

    future<compaction_stats_opt> rewrite_sstables(compaction::table_state& t, sstables::compaction_type_options options, compaction::owned_ranges_ptr, get_candidates_func, can_purge_tombstones can_purge = can_purge_tombstones::yes);
...
public:
    ...
    bool update_sstable_cleanup_state(compaction::table_state& t, const sstables::shared_sstable& sst, compaction::owned_ranges_ptr owned_ranges_ptr);
