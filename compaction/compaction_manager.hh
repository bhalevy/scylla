...
private:
    ...
    std::vector<sstables::shared_sstable> get_candidates(const column_family& cf, std::optional<std::vector<sstables::shared_sstable>> sstables_opt = std::nullopt);
...
public:
    ...
    future<> perform_sstable_scrub(column_family* cf, sstables::compaction_type_options::scrub opts);
