...
bool compaction_manager::update_sstable_cleanup_state(compaction::table_state& t, const sstables::shared_sstable& sst, compaction::owned_ranges_ptr owned_ranges_ptr) {
