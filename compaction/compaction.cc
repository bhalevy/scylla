...
get_fully_expired_sstables(const table_state& table_s, const std::vector<sstables::shared_sstable>& compacting, const compaction_manager& cm, gc_clock::time_point compaction_time) {
