...
private:
    cleanup_compaction(column_family& cf, compaction_descriptor descriptor, dht::token_range_vector owned_ranges)
...
public:
    cleanup_compaction(column_family& cf, compaction_descriptor descriptor, compaction_type_options::cleanup opts)
        : cleanup_compaction(cf, std::move(descriptor), opts.owned_ranges) {}
