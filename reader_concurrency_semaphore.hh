...
public:
    ...
    /// it is evicted.
    future<inactive_read_handle> register_inactive_read(flat_mutation_reader ir) noexcept;
    ...
    /// and before calling set_notify_handler.
    /// Therefore, the caller must make revalidate the inactive_read_handle
